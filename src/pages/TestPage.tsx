  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {habits.map(habit => {
        ...
        const points18 = Math.round(last18.reduce((a, d) => a + (pointsByDate[d] ?? 0), 0) * 100) / 100;
                ...
                <div className="border-t border-border pt-2 mt-1 space-y-3">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between text-xs text-muted-foreground mt-2">
                      <span>Points 18j : <span className={cn("font-medium", points18 > 0 ? "text-green-600 dark:text-green-400" : points18 < 0 ? "text-red-600 dark:text-red-400" : "text-foreground")}>{points18}</span></span>
